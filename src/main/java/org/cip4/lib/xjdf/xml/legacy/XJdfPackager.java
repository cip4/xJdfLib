...
public class XJdfPackager extends AbstractXmlPackager<XJDF> {
     ...
     */
    public final void packageXjdf(final XJDF xjdf) throws XJdfPackagerException {
     ...
     * @throws XJdfPackagerException If the XML document could not be packaged.
     */
    public final void packageXjdf(final XJDF xjdf, String docName) throws XJdfPackagerException {
    ...
    protected final byte[] parseDocument(final XJDF xjdf, final boolean validation) throws Exception {
        return null; // new XJdfParser().writeXJdf(xjdf, !validation);
    }
}