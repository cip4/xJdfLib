    ...
    implements Serializable
{
    ...
    @XmlAttribute(name = "SignalTypes")
    protected List<String> signalTypes;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the signalTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mileStoneTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<String> getMileStoneTypes() {
        if (mileStoneTypes == null) {
            mileStoneTypes = new ArrayList<String>();
        }
