    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "ParameterType", namespace = "http://www.CIP4.org/JDFSchema_2_0", type = JAXBElement.class)
    protected List<JAXBElement<? extends ParameterType>> parameterType;
     ...
     * {@link JAXBElement }{@code <}{@link StrippingParams }{@code >}
     ...
     * 
     */
    public List<JAXBElement<? extends ParameterType>> getParameterType() {
        if (parameterType == null) {
            parameterType = new ArrayList<JAXBElement<? extends ParameterType>>();
        }
