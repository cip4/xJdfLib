...
/**
 * <p>Java class for ApprovalSuccess complex type.
 * 
...
@XmlType(name = "ApprovalSuccess", propOrder = {
    "approvalDetails"
})
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the approvalDetails property.
     * 
     * <p>
    ...
    public List<ApprovalDetails> getApprovalDetails() {
        if (approvalDetails == null) {
            approvalDetails = new ArrayList<ApprovalDetails>();
        }
