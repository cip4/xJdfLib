...
/**
 * <p>Java class for EnumPipePartIDKeys.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="EnumPipePartIDKeys">
 ...
 * 
 */
@XmlType(name = "EnumPipePartIDKeys")
@XmlEnum
public enum EnumPipePartIDKeys {
    ...
    public static EnumPipePartIDKeys fromValue(String v) {
        for (EnumPipePartIDKeys c: EnumPipePartIDKeys.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
